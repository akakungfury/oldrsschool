const enKeysLayout = [
  ...
  [
    {
      eWhich: 16, eCode: 'ShiftLeft', eKey: 'Shift', eKeyShift: 'ShiftLeft',
    },
    {
    ...
    {
      eWhich: 16, eCode: 'ShiftRight', eKey: 'Shift', eKeyShift: 'ShiftRight',
    },
  ],
  [
    {
      eWhich: 17, eCode: 'ControlLeft', eKey: 'Ctrl', eKeyShift: 'ControlLeft',
    },
    {
      eWhich: 91, eCode: 'MetaLeft', eKey: 'Win', eKeyShift: 'Win',
    },
    {
      eWhich: 18, eCode: 'AltLeft', eKey: 'Alt', eKeyShift: 'AltLeft',
    },
    {
      eWhich: 32, eCode: 'Space', eKey: ' ', eKeyShift: ' ',
    },
    {
      eWhich: 18, eCode: 'AltRight', eKey: 'Alt', eKeyShift: 'AltRight',
    },
    {
    ...
    {
      eWhich: 17, eCode: 'ControlRight', eKey: 'Ctrl', eKeyShift: 'CtrlRight',
    },
  ],
];
...
const ruKeysLayout = [
  ...
  [
    ...
    {
      eWhich: 46, eCode: 'Delete', eKey: 'Delete', eKeyShift: 'Delete',
    },
  ],
  [
    {
    ...
    {
      eWhich: 69, eCode: 'KeyD', eKey: 'в', eKeyShift: 'В',
    },
    {
  ...
  [
    {
      eWhich: 17, eCode: 'ControlLeft', eKey: 'Ctrl', eKeyShift: 'CtrlLeft',
    },
    {
      eWhich: 91, eCode: 'MetaLeft', eKey: 'Win', eKeyShift: 'Win',
    },
    ...
    {
      eWhich: 32, eCode: 'Space', eKey: ' ', eKeyShift: 'Space',
    },
    {
      eWhich: 18, eCode: 'AltRight', eKey: 'Alt', eKeyShift: 'AltRight',
    },
...
const keyWhich = [192, 49, 50, 51, 52, 53, 54, 55, 56, 57, 48, 189, 187, 8, 9, 81, 87,
  69, 82, 84, 89, 85, 73, 79, 80, 219, 221, 220, 46, 20, 65, 83, 68, 70,
  71, 72, 74, 75, 76, 186, 222, 13, 16, 90, 88, 67, 86, 66, 78, 77, 188,
  190, 191, 38, 16, 17, 91, 18, 32, 18, 37, 40, 39, 17];

export { enKeysLayout, ruKeysLayout, keyWhich };
